...
wget https://raw.githubusercontent.com/citrix-openstack/config/new_master/install_puppet.sh
sudo bash -xe install_puppet.sh

sudo git clone http://github.com/citrix-openstack/config --branch new_master \
    /root/config
